...
def forward():
    ...
    pwm1.ChangeDutyCycle(40)   # Set motor 1 speed (0-100)
    pwm2.ChangeDutyCycle(40)   # Set motor 2 speed (0-100)
...
def left():
    ...
    pwm1.ChangeDutyCycle(30)   # Set motor 1 speed (0-100)
...
def right():
    ...
    pwm2.ChangeDutyCycle(30)   # Set motor 2 speed (0-100)
